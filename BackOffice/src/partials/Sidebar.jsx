    ...
    <div>
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className='fill-slate-100 text-white w-16 mt-4' viewBox="0 0 398 274.66"><title>logo</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M202.11,0c3,.7,6.07,1.18,9,2.14,25.45,8.37,34.55,40,17.58,60.66Q213.24,81.63,198,100.56l-101.46,125c-9.35,11.52-18.65,23.08-28,34.57a37.63,37.63,0,0,1-25.1,14,7.35,7.35,0,0,0-1.39.47H35.24a7.3,7.3,0,0,0-1.39-.46A38.21,38.21,0,0,1,1.27,244.9c-.54-2.32-.85-4.69-1.27-7v-3.63c.44-2.34.79-4.7,1.32-7,1.69-7.45,6-13.33,10.81-19.13C26.51,190.65,40.56,173,54.8,155.39Q111.86,85,169,14.71c3.7-4.57,8-8.45,13.45-10.64,4.34-1.74,9-2.74,13.49-4.07Z"/><path d="M195.89,274.66c-2.83-.66-5.73-1.12-8.49-2-26.83-8.53-35.42-41.64-16.65-62.6,9.42-10.54,17.86-22,26.78-32.94,18.89-23.24,37.9-46.39,56.66-69.73,4.88-6.08,10-11.63,17.24-14.85a38.4,38.4,0,0,1,46.71,12.37c10.66,14.55,9.36,34.49-2.42,48.3-11.58,13.6-22.52,27.73-33.79,41.59-16.56,20.36-33.26,40.59-49.67,61.07-5,6.28-10.15,12.3-17.82,15.29-4,1.54-8.21,2.36-12.33,3.5Z"/><path d="M42,0c2,.43,4,.81,6,1.31A38.33,38.33,0,1,1,.44,42.09,9.15,9.15,0,0,0,0,40.42V36.79A10.22,10.22,0,0,0,.43,35.1,38.12,38.12,0,0,1,28.55,1.52C30.75.92,33,.5,35.24,0Z"/><path d="M398,40.42c-.44,2.34-.76,4.71-1.32,7C392.14,65.9,376,77.64,356.53,76.7c-17.47-.84-32.46-14.87-35.12-32.86A38.35,38.35,0,0,1,354.63.47,7.35,7.35,0,0,0,356,0h6.74a7.3,7.3,0,0,0,1.39.46,38.22,38.22,0,0,1,32.58,29.3c.54,2.32.85,4.69,1.27,7Z"/></g></g></svg>
          </NavLink>
        </div>
                      ...
                      <a href="#0" className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('ecommerce') && 'hover:text-slate-200'}`} onClick={(e) => { e.preventDefault(); sidebarExpanded ? handleClick() : setSidebarExpanded(true) }}>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Books</span>
                          </div>
                          {/* Icon */}
                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/" className="block text-slate-400 hover:text-slate-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Review List</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/" className="block text-slate-400 hover:text-slate-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Action List</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/" className="block text-slate-400 hover:text-slate-200 transition duration-150 truncate">
